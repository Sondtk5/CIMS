...
function UnauthorizedMessage() {
  return (
    <Card sx={{ borderLeft: '4px solid #dc2626', mt: 3 }}>
      <CardContent>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          <Box sx={{ color: '#dc2626', fontSize: 40 }}>🔒</Box>
          <Box>
            <Typography variant="h6" sx={{ fontWeight: 700, color: '#dc2626' }}>
              Insufficient Permissions
            </Typography>
            <Typography variant="body2" sx={{ color: '#64748b' }}>
              Only administrators can access this section. Please contact your system administrator.
            </Typography>
          </Box>
        </Box>
      </CardContent>
...
export default function AdminSettings() {
  ...
  const [tabValue, setTabValue] = useState(isAdmin ? 0 : 3); // Default to Change Password if not admin
              ...
              <Table size="small">
                <TableHead>
                  <TableRow sx={{ backgroundColor: '#f1f5f9' }}>
                    ...
                    <TableCell sx={{ fontWeight: 'bold' }}>Default Pass</TableCell>
                ...
                <TableBody>
                  {users.map((u) => (
                    <TableRow key={u.id} hover>
                      ...
                      <TableCell>
                        <Typography variant="caption" sx={{ backgroundColor: '#f1f5f9', px: 1, py: 0.5, borderRadius: 1, fontFamily: 'monospace' }}>
                          {roleDefaults[u.role] || 'N/A'}
                        </Typography>
                      </TableCell>
                      <TableCell>
                ...
                <TableBody>
                  {roles.map((r) => (
                    <TableRow key={r.id} hover>
                      ...
                      <TableCell>
                        <Typography variant="caption" sx={{ backgroundColor: '#e0e7ff', px: 1.5, py: 0.5, borderRadius: 1 }}>
                          {r.user_count} user(s)
                        </Typography>
                      </TableCell>
                      ...
                      <TableCell sx={{ fontSize: '0.85rem' }}>{r.updated_by || 'System'}</TableCell>
                      <TableCell>
